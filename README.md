...
**Download for macOS:** [Universal (Intel + Apple Silicon)](https://github.com/tjamjam/claude-code-dashboard/releases/latest/download/Claude.Code.Dashboard-1.0.0-universal.dmg) | [Apple Silicon only](https://github.com/tjamjam/claude-code-dashboard/releases/latest/download/Claude.Code.Dashboard-1.0.0-arm64.dmg)
