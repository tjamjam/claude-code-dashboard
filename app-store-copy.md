# Claude Code Dashboard — App Store Copy
...
Your AI dev setup, visualized

## Promotional Text (170 characters max — can be updated without a new build)

See your entire Claude Code configuration across every repo. Manage permissions, audit skills, and optimize your AI workflow from one dashboard.

## Description

Claude Code Dashboard gives you a visual command center for your entire Claude Code setup — the configuration, skills, agents, commands, and permissions scattered across ~/.claude/ and all your GitHub repos, unified in one place.
...
- CLAUDE.md viewer with improvement prompts
- Usage insights from /insights reports
- Settings viewer with raw JSON access
- Quick-launch: copy `cd && claude` for any repo

## Keywords (100 characters max, comma-separated)

claude,ai,developer,tools,dashboard,code,mcp,agents,skills,permissions,llm,configuration
...
Initial release of Claude Code Dashboard — a visual command center for your Claude Code setup across all your repos.

## Privacy Policy URL

(Required — needs to be hosted somewhere, e.g., a GitHub Pages site or simple static page)

## Support URL

https://github.com/terrencefradet/claude-code-dashboard/issues

## Copyright

2026 Terrence Fradet
...
1. **Overview** — "Your entire Claude Code setup at a glance"
2. **Repos** — "Search and manage Claude config across all your repos"
3. **Skills** — "Browse global and repo-level skills with audit prompts"
4. **Settings** — "Toggle tool permissions with one click"
5. **MCP** — "Monitor MCP servers, connections, and permissions"
6. **Repo Detail** — "Deep dive into any repo's Claude configuration"
