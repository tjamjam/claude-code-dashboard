...
// Overview stats
ipcMain.handle('/api/overview', () => getOverview({ claudeDir: CLAUDE_DIR, reposDir: REPOS_DIR }))
...
ipcMain.handle('/api/rules', () => getRules({ claudeDir: CLAUDE_DIR, reposDir: REPOS_DIR }))
ipcMain.handle('/api/hooks', () => getHooks({ claudeDir: CLAUDE_DIR, reposDir: REPOS_DIR }))
ipcMain.handle('/api/permissions-full', () => getPermissionsFull({ claudeDir: CLAUDE_DIR, reposDir: REPOS_DIR }))
ipcMain.handle('/api/env-vars', () => getEnvVars({ claudeDir: CLAUDE_DIR, reposDir: REPOS_DIR }))
ipcMain.handle('/api/tasks', () => getTasks({ claudeDir: CLAUDE_DIR }))
ipcMain.handle('/api/plugins-full', () => getPluginsFull({ claudeDir: CLAUDE_DIR }))
ipcMain.handle('/api/context', () => getContext({ claudeDir: CLAUDE_DIR }))
ipcMain.handle('/api/launch-profiles', () => getLaunchProfiles({ claudeDir: CLAUDE_DIR }))
